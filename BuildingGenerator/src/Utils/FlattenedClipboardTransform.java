...
public class FlattenedClipboardTransform {
    ...
    public static class SchematicSaveTask implements Callable<Void> {
        ...
        SchematicSaveTask( File file, ClipboardFormat format, ClipboardHolder holder, boolean overwrite) {
